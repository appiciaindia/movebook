            ...
            <div className="card mb-4">
              ...
              <div className="card-body row">
                <div className="col-6 mb-2">
                  <label className={styles.labelSize} htmlFor="origin_country">
                    Country (देश)
                  </label>
                  <input
                ...
                <div className="col-6 mb-2">
                  <label className={styles.labelSize} htmlFor="origin_pincode">
                    PinCode(पिन कोड)
                  </label>
                  <input
                    className="form-control"
                ...
                <div className="col-12 mb-2">
                  <label className={styles.labelSize} htmlFor="origin_address">
                    Address (पता)
                  </label>
                  <textarea
                    type="text"
          ...
          <div className="col-md-6">
            <div className="card mb-4">
              ...
              <div className="card-body row">
                ...
                <div className="col-6 mb-2">
                  <label className={styles.labelSize} htmlFor="desination_city">
                    City (शहर)
                  </label>
                  <input
                    className="form-control"
            ...
            <div className="card mb-4">
              ...
              <div className="card-body row g-4">
                <div className="col-lg-4 col-6">
                  <label className={styles.labelSize} htmlFor="freight_charge">
                    Freight Charge
                  </label>
                  <input
                    className="form-control"
                ...
                <div className="col-lg-4">
                  <label className={styles.labelSize} htmlFor="packing_charge">
                    Packing Charge
                  </label>
                ...
                <div className="col-lg-4">
                  ...
                  <div className="input-group">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      readOnly={
                        formData.unpacking_charge_type === "Included in Freight"
                      }
                    />
                  </div>
                </div>
                <div className="col-lg-4">
                  <label className={styles.labelSize} htmlFor="loading_charge">
                    Loading Charge
                  </label>
                  <div className="input-group">
                    {/* Select */}
                ...
                <div className="col-lg-4">
                  ...
                  <div className="input-group">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      readOnly={
                        formData.unloading_charge_type === "Included in Freight"
                      }
                    />
                  </div>
                </div>
                ...
                <div className="col-lg-4 col-6">
                  <label className={styles.labelSize} htmlFor="storage_charge">
                    Storage Charge
                  </label>
                  <input
                    className="form-control"
            ...
            <div className="card mb-4">
              ...
              <div className="card-body row g-4">
                <div className="col-12">
                  <label className={styles.labelSize} htmlFor="insurance_type">
                    Insurance Type
                  </label>
                  <select
                    name="insurance_type"
                  ...
                  >
                    ...
                    <option value="Show Insurance Amount">
                ...
                <div className="col-lg-5 col-4">
                  <label className={styles.labelSize} htmlFor="ins_gst_percent">
                    GST %
                  </label>
                  <select
                ...
                <div className="col-12">
                  ...
                  <input
                    ...
                    readOnly={
                      formData.insurance_type !== "Show Insurance Amount"
                    }
                  />
                </div>
              </div>
              ...
              <div className="card-body row g-4">
                ...
                <div className="col-12">
                  ...
                  <input
                    ...
                    readOnly={
                      formData.vehicle_insurance_type !==
                      "Additional from Freight"
                    }
                  />
                </div>
            ...
            <div className="card mb-4">
              ...
              <div className="card-body row g-4">
                ...
                <div className="col-lg-6">
                  ...
                  >
                    Should any items be got down through balcony etc. (क्या किसी
                    सामान को बालकनी से नीचे उतारना हैं?)
                  </label>
